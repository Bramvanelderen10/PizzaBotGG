...
namespace PizzaBotGG.App.Modules.Music.Services
{
	public class MusicService : IMusicService
	{
		...
		public async Task Connect(CommandContext context)
		{
			...
			{
				LavalinkGuildConnection = LavalinkNodeConnection.GetGuildConnection(context.Member.VoiceState.Guild);
				if (LavalinkGuildConnection == null)
				{
		...
		public async Task Play(CommandContext context, string search)
		{
